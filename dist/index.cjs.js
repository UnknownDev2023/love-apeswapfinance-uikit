...
var Button = function (_a) {
    ...
    return (React__default['default'].createElement(StyledButton, __assign({}, internalProps, props, { isLoading: isLoading, disabled: isDisabled, fontFamily: fontFamily }),
...
var StyledButtonSquare = styled__default['default'].button(templateObject_1$7 || (templateObject_1$7 = __makeTemplateObject(["\n  align-items: center;\n  background-color: #ffb300;\n  border-radius: 5px;\n  border: none;\n  box-shadow: none;\n  color: white;\n  cursor: pointer;\n  display: inline-flex;\n  font-size: 12px;\n  font-weight: 400;\n  /* max-content instead of auto for Safari fix */\n  width: ", ";\n  height: ", ";\n  line-height: 1;\n  letter-spacing: 0.03em;\n  justify-content: center;\n  outline: 0;\n  padding: ", ";\n  transition: background-color 0.2s;\n  opacity: ", ";\n\n  &:hover:not(:disabled):not(.button--disabled):not(:active) {\n    background-color: ", ";\n  }\n\n  &:focus:not(:active) {\n    box-shadow: 0 0 0 2px ", ";\n  }\n\n  &:active {\n    box-shadow: ", ";\n  }\n\n  ", "\n  ", "\n  ", "\n"], ["\n  align-items: center;\n  background-color: #ffb300;\n  border-radius: 5px;\n  border: none;\n  box-shadow: none;\n  color: white;\n  cursor: pointer;\n  display: inline-flex;\n  font-size: 12px;\n  font-weight: 400;\n  /* max-content instead of auto for Safari fix */\n  width: ", ";\n  height: ", ";\n  line-height: 1;\n  letter-spacing: 0.03em;\n  justify-content: center;\n  outline: 0;\n  padding: ", ";\n  transition: background-color 0.2s;\n  opacity: ", ";\n\n  &:hover:not(:disabled):not(.button--disabled):not(:active) {\n    background-color: ", ";\n  }\n\n  &:focus:not(:active) {\n    box-shadow: 0 0 0 2px ", ";\n  }\n\n  &:active {\n    box-shadow: ", ";\n  }\n\n  ", "\n  ", "\n  ", "\n"])), function (_a) {
    var fullWidth = _a.fullWidth;
    return (fullWidth ? "100%" : "max-content");
}, function (_a) {
    var size = _a.size;
    ...
    var theme = _a.theme;
    return theme.colors.secondary;
}, getButtonVariantProp$1("boxShadowActive"), getDisabledStyles$1, removePointerEvents$1, styledSystem.space);
...
var ButtonSquare = function (_a) {
    ...
    var internalProps = external ? getExternalLinkProps() : {};
    var isDisabled = isLoading || disabled;
    return (React__default['default'].createElement(StyledButtonSquare, __assign({}, internalProps, props, { isLoading: isLoading, disabled: isDisabled }),
        React__default['default'].isValidElement(startIcon) &&
            React__default['default'].cloneElement(startIcon, {
                mr: "0.5rem",
            }),
...
var IconButtonSquare = styled__default['default'](ButtonSquare)(templateObject_1$8 || (templateObject_1$8 = __makeTemplateObject(["\n  padding: 0;\n  width: ", ";\n"], ["\n  padding: 0;\n  width: ", ";\n"])), function (_a) {
    var size = _a.size;
    return (size === "sm" ? "32px" : "48px");
});
...
var ButtonMenuItem = function (_a) {
    ...
    if (!isActive) {
        return (React__default['default'].createElement(InactiveButton, __assign({ forwardedAs: as, size: size, variant: "tertiary", colorKey: variant === variants.PRIMARY || variants.YELLOW ? "primary" : "textSubtle", fontFamily: fontFamily, fontSize: fontSize }, props)));
    }
    return React__default['default'].createElement(Button, __assign({ as: as, size: size, variant: variant, fontFamily: fontFamily, fontSize: fontSize }, props));
};
...
var Icon$S = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 1512 1512" }, props),
        React__default['default'].createElement("defs", null,
        ...
        React__default['default'].createElement("path", { className: "cls-1", d: "M107.06,284a275.78,275.78,0,0,0-9.82,71.82c0,1.7,0,3.37,0,5,.37,29.36-3.27,58.53-9.82,87.11C73.93,443.21,60,433.48,46.72,416.67c-34.95-44.27-23.3-115.33,19.81-132,16.31-6.32,30-5,40.61-.84Z" }),
        React__default['default'].createElement("path", { className: "cls-2", d: "M107.06,284a275.78,275.78,0,0,0-9.82,71.82c0,1.7,0,3.37,0,5,.37,29.36-3.27,58.53-9.82,87.11C73.93,443.21,60,433.48,46.72,416.67c-34.95-44.27-23.3-115.33,19.81-132,16.31-6.32,30-5,40.61-.84Z" }),
        React__default['default'].createElement("path", { className: "cls-1", d: "M751.29,416.67C738,433.46,724.09,443.19,710.57,448a369.59,369.59,0,0,1-9.83-87.1c0-1.66,0-3.33,0-5a274.93,274.93,0,0,0-9.9-72.08c10.66-4.14,24.3-5.48,40.61.84C774.59,301.34,786.24,372.4,751.29,416.67Z" }),
        React__default['default'].createElement("path", { className: "cls-2", d: "M751.29,416.67C738,433.46,724.09,443.19,710.57,448a369.59,369.59,0,0,1-9.83-87.1c0-1.66,0-3.33,0-5a274.93,274.93,0,0,0-9.9-72.08c10.66-4.14,24.3-5.48,40.61.84C774.59,301.34,786.24,372.4,751.29,416.67Z" }),
        React__default['default'].createElement("path", { className: "cls-1", d: "M616.94,448.92c-12.69,19.9-16.2,44.53-8.58,67,5.74,16.9,10.87,36,10.87,50.25,0,104.06-98.59,188.41-220.23,188.41S178.76,670.21,178.76,566.15c0-14.23,5.14-33.34,10.88-50.25,7.61-22.43,4.12-47.08-8.58-67A122.58,122.58,0,0,1,172.93,434,119.35,119.35,0,0,1,162,384c0-69.1,58.83-125.12,131.41-125.12a135.88,135.88,0,0,1,66.94,17.44,78.21,78.21,0,0,0,77.29,0,135.76,135.76,0,0,1,66.92-17.42c72.59,0,131.42,56,131.42,125.12a119.39,119.39,0,0,1-10.91,50A122.51,122.51,0,0,1,616.94,448.92Z" }),
        React__default['default'].createElement("path", { className: "cls-2", d: "M616.94,448.92c-12.69,19.9-16.2,44.53-8.58,67,5.74,16.9,10.87,36,10.87,50.25,0,104.06-98.59,188.41-220.23,188.41S178.76,670.21,178.76,566.15c0-14.23,5.14-33.34,10.88-50.25,7.61-22.43,4.12-47.08-8.58-67A122.58,122.58,0,0,1,172.93,434,119.35,119.35,0,0,1,162,384c0-69.1,58.83-125.12,131.41-125.12a135.88,135.88,0,0,1,66.94,17.44,78.21,78.21,0,0,0,77.29,0,135.76,135.76,0,0,1,66.92-17.42c72.59,0,131.42,56,131.42,125.12a119.39,119.39,0,0,1-10.91,50A122.51,122.51,0,0,1,616.94,448.92Z" }),
        React__default['default'].createElement("path", { className: "cls-3", d: "M286.81,589.43a12.65,12.65,0,0,0-12.55,14.29c7.8,55.75,60.68,98.88,124.75,98.88S516,659.47,523.76,603.72a12.66,12.66,0,0,0-12.56-14.29Z" }),
        React__default['default'].createElement("path", { className: "cls-4", d: "M326.55,681.83a136.76,136.76,0,0,0,144.91,0c-9.08-31.47-38.16-24.22-72.45-24.22S335.64,650.36,326.55,681.83Z" }),
        React__default['default'].createElement("path", { className: "cls-1", d: "M746.39,261.35c-26.06-10.11-46.75-4.78-61.28,3.58a320.3,320.3,0,0,0-12.25-30.74q-5.05-11-10.92-21.73C622.06,139.49,555,78.92,478,53.32l-1.52-41.41L426.7,41.81c-2-.22-4-.44-6-.62-3.68-.34-7.34-.59-11.05-.75L402.37,9.12,400.24,0c-2.48,0-4.92.07-7.28.27-46.37,3.76-69.44,45.88-73,53.1C243,79,176,139.52,136.07,212.46q-5.87,10.69-10.92,21.73A323.37,323.37,0,0,0,112.89,265c-.61-.37-1.23-.72-1.87-1.05-14.42-7.74-34.46-12.22-59.4-2.55C-3.15,282.59-17.93,372.86,26.45,429.11c18.11,22.9,37.17,35.44,55.52,41-.25,1-.47,2.07-.7,3.1a214.9,214.9,0,0,0-5,46.08c0,107.45,79.26,199.87,192.8,240.54a376.31,376.31,0,0,0,82.44,19.33,397.33,397.33,0,0,0,44,2.82c1.16,0,2.33,0,3.49,0C577.23,782,721.7,664.39,721.7,519.31a215.53,215.53,0,0,0-5-46.08c-.23-1-.46-2.07-.7-3.09,18.35-5.59,37.41-18.13,55.5-41.05C815.94,372.86,801.14,282.58,746.39,261.35ZM107.06,284a275.78,275.78,0,0,0-9.82,71.82c0,1.7,0,3.37,0,5,.37,29.36-3.27,58.53-9.82,87.11C73.93,443.21,60,433.48,46.72,416.67c-34.95-44.27-23.3-115.33,19.81-132,16.31-6.32,30-5,40.61-.84Zm518,150a122.51,122.51,0,0,1-8.14,14.93c-12.69,19.9-16.2,44.53-8.58,67,5.74,16.9,10.87,36,10.87,50.25,0,104.06-98.59,188.41-220.23,188.41S178.76,670.21,178.76,566.15c0-14.23,5.14-33.34,10.88-50.25,7.61-22.43,4.12-47.08-8.58-67A122.58,122.58,0,0,1,172.93,434,119.35,119.35,0,0,1,162,384c0-69.1,58.83-125.12,131.41-125.12a135.88,135.88,0,0,1,66.94,17.44,78.21,78.21,0,0,0,77.29,0,135.76,135.76,0,0,1,66.92-17.42c72.59,0,131.42,56,131.42,125.12A119.39,119.39,0,0,1,625.08,434Zm126.21-17.32C738,433.46,724.09,443.19,710.57,448a369.59,369.59,0,0,1-9.83-87.1c0-1.66,0-3.33,0-5a274.93,274.93,0,0,0-9.9-72.08c10.66-4.14,24.3-5.48,40.61.84C774.59,301.34,786.24,372.4,751.29,416.67Z" }),
        React__default['default'].createElement("rect", { className: "cls-3", x: 355.46, y: 481.55, width: 21.16, height: 48.06, rx: 10.58, transform: "translate(-245.92 628.44) rotate(-65.45)" }),
        React__default['default'].createElement("rect", { className: "cls-3", x: 421.4, y: 481.55, width: 21.16, height: 48.06, rx: 10.58, transform: "translate(151.6 1108.57) rotate(-114.55)" }),
        React__default['default'].createElement("path", { className: "cls-3", d: "M285.83,434h0c-20.83,0-37.72-16-37.72-35.75V386.3c0-19.75,16.89-35.75,37.72-35.75h0c20.84,0,37.73,16,37.73,35.75v11.91C323.56,418,306.67,434,285.83,434Z" }),
        React__default['default'].createElement("path", { className: "cls-5", d: "M285.83,350.55v41.71c0,9.87,8.45,17.87,18.86,17.87s18.87-8,18.87-17.87v-6C323.56,366.55,306.67,350.55,285.83,350.55Z" }),
        React__default['default'].createElement("ellipse", { className: "cls-6", cx: 285.84, cy: 374.39, rx: 12.57, ry: 11.92 }),
        React__default['default'].createElement("path", { className: "cls-3", d: "M512.17,434h0c-20.83,0-37.72-16-37.72-35.75V386.3c0-19.75,16.89-35.75,37.72-35.75h0c20.84,0,37.73,16,37.73,35.75v11.91C549.9,418,533,434,512.17,434Z" }),
        React__default['default'].createElement("path", { className: "cls-5", d: "M512.17,350.55v41.71c0,9.87,8.45,17.87,18.86,17.87s18.87-8,18.87-17.87v-6C549.9,366.55,533,350.55,512.17,350.55Z" }),
        React__default['default'].createElement("ellipse", { className: "cls-6", cx: 512.17, cy: 374.39, rx: 12.57, ry: 11.92 }),
        React__default['default'].createElement("path", { className: "cls-7", d: "M402.37,9.12c-8.44-.84-26.92,12.44-49.05,35.48-5.51,5.74-11.26,12.11-17.16,19C292.81,114.46,242.55,194.66,225.33,277c-28.9,138.17-40.64,298.47,10.35,387.39C278.9,739.7,351.54,779.18,351.54,779.18a376.31,376.31,0,0,1-82.44-19.33C155.56,719.18,76.3,626.76,76.3,519.31a214.9,214.9,0,0,1,5-46.08c.23-1,.45-2.07.7-3.1-18.35-5.58-37.41-18.12-55.52-41-44.38-56.25-29.6-146.52,25.17-167.76,24.94-9.67,45-5.19,59.4,2.55.64.33,1.26.68,1.87,1.05a323.37,323.37,0,0,1,12.26-30.76q5.06-11,10.92-21.73C176,139.52,243,79,319.92,53.36c3.6-7.22,26.67-49.34,73-53.1,2.36-.2,4.8-.29,7.28-.27Z" })));
};
...
var RotatingPancakeIcon = styled__default['default'](Icon$T)(templateObject_4$1 || (templateObject_4$1 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"])), rotate$1);
var FloatingPanIcon = styled__default['default'](Icon$S)(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"])), float);
        ...
        React__default['default'].createElement(ModalHeader, null,
            React__default['default'].createElement(ModalTitle, null,
                onBack && (React__default['default'].createElement(IconButton, { variant: "text", onClick: onBack, "area-label": "go back", mr: "8px" },
                    React__default['default'].createElement(Icon$6, { color: "primary" }))),
...
var Icon$Z = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 100 100" }, props),
        React__default['default'].createElement("path", { d: "M82.42,8.55a3.78,3.78,0,0,0-6.86,1.74C73.19,30,65.45,44.26,55.77,55l-17-1.37L28.67,67.16,36,71.38c-2.25,1.44-4.48,2.77-6.68,4a3.78,3.78,0,0,0,.95,7A58.1,58.1,0,0,0,39.92,84l-1.41,8,17.3,1.06L65.11,80C90.35,68.6,101.7,36.36,82.42,8.55Z" }),
        React__default['default'].createElement("path", { d: "M22.87,83.27a12.82,12.82,0,0,1-11,.8L8.38,82.71a.8.8,0,0,1-.18-1.38l3-2.17a12.79,12.79,0,0,1,7.5-2.43,13.12,13.12,0,0,1,3.4.45A3.33,3.33,0,0,1,22.87,83.27Z" })));
};
...
var StyledLogo = styled__default['default'].h1(templateObject_1$z || (templateObject_1$z = __makeTemplateObject(["\n  font-family: \"Titan One\", cursive;\n  color: #af6e5a;\n  font-weight: 400;\n  font-size: 20px;\n  margin-left: 8px;\n"], ["\n  font-family: \"Titan One\", cursive;\n  color: #af6e5a;\n  font-weight: 400;\n  font-size: 20px;\n  margin-left: 8px;\n"])));
var Logo$1 = function () {
...
var Icon$10 = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 100 100" }, props),
        React__default['default'].createElement("path", { d: "M15.42 47.18A34.73 34.73 0 0122 29.58a2.15 2.15 0 013.26-.24L32 36.09a2.15 2.15 0 01.29 2.67 21.06 21.06 0 0013.19 31.85 2.15 2.15 0 011.68 2.09v9.56a2.16 2.16 0 01-2.47 2.14 34.75 34.75 0 01-29.27-37.22M54.64 70.61a21 21 0 0016-16A2.15 2.15 0 0172.71 53h9.56a2.16 2.16 0 012.14 2.48 34.76 34.76 0 01-29 29A2.15 2.15 0 0153 82.27v-9.56a2.15 2.15 0 011.64-2.1zM72.71 47.17a2.13 2.13 0 01-2.09-1.68 21 21 0 00-31.86-13.2 2.15 2.15 0 01-2.67-.29l-6.75-6.76a2.15 2.15 0 01.24-3.24 34.76 34.76 0 0154.83 22.69 2.16 2.16 0 01-2.14 2.48z" }),
        React__default['default'].createElement("path", { d: "M37 54.77a5.56 5.56 0 001.19 1.6 15.58 15.58 0 0023.11-4.62 15.75 15.75 0 001.94-6.22A5.64 5.64 0 0063 43.3a1.74 1.74 0 00-.67-.88l.21-1.37a.57.57 0 00-.48-.65h-.4a.57.57 0 00-.65.48l-.21 1.39a1.89 1.89 0 00-.94.69v.06l-.06.11c-.06.14-.11.29-.16.43s-.11.26-.16.38-.09.2-.13.29v.07l-.09.18c-.07.15-.14.3-.22.45s-.09.16-.13.25l-.22.4-.15.26-.23.37-.17.25c-.08.13-.16.25-.25.37l-.11.15-.2.28-.15.19-.15.18-.18.23-.23.26-.12.12-.18.21-.22.22c-.06.06-.11.12-.17.17l-.28.27-.3.27-.22.19-.27.23-.27.22-.13.09-.15.11a3.55 3.55 0 01-.31.23l-.26.18-.33.22-.13.08-.14.09-.34.2-.23.13c-.15.08-.3.17-.46.24l-.16.08-.29.13a2.75 2.75 0 01-.3.14l-.34.15-.3.11c-.1.05-.21.08-.31.12h-.08l-.22.08-.31.1h-.13l-.22.07-.35.1h-.22l-.77.17-.77.13H47l-.65.07H43.7l-.7.24a5.58 5.58 0 01-.59-.09 25.91 25.91 0 00-4.09-.51 4 4 0 00-.64.07 1.7 1.7 0 00-.51.19 1.59 1.59 0 00-.24.2l-.08.13a.88.88 0 00-.05.15 2.17 2.17 0 00.2 1.35z" })));
};
...
var Logo$3 = function (_a) {
    ...
    var innerLogo = (React__default['default'].createElement(React__default['default'].Fragment, null,
        React__default['default'].createElement(FullLogo, { width: "160px" })));
    return (React__default['default'].createElement(Flex, null,
        React__default['default'].createElement(MenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px" }, isPushed ? (React__default['default'].createElement(Icon$X, { width: "24px", color: "textSubtle" })) : (React__default['default'].createElement(Icon$W, { width: "24px", color: "textSubtle" }))),
...
var Accordion = function (_a) {
    ...
    return (React__default['default'].createElement(Container$2, null,
        React__default['default'].createElement(MenuEntry, { onClick: handleClick, className: className },
            ...
            isOpen ? React__default['default'].createElement(Icon$b, null) : React__default['default'].createElement(Icon$9, null)),
...
var PanelFooter = function (_a) {
    ...
    return (React__default['default'].createElement(Container$4, null,
        React__default['default'].createElement(SocialEntry, null,
            cakePriceUsd ? (React__default['default'].createElement(PriceLink, { href: "https://info.apeswap.finance/token/0x603c7f932ed1fc6575303d8fb018fdcbb0f39a95", target: "_blank" },
        ...
        React__default['default'].createElement(SettingsEntry, null,
            ...
            langs && (React__default['default'].createElement(Dropdown, { position: "top-right", target: React__default['default'].createElement(Button, { variant: "text", startIcon: React__default['default'].createElement(LanguageIcon, { color: "textSubtle", width: "24px" }) },
...
var Menu = function (_a) {
    ...
    return (React__default['default'].createElement(Wrapper$1, null,
        React__default['default'].createElement(StyledNav, { showMenu: showMenu },
            React__default['default'].createElement(Logo$3, { isPushed: isPushed, togglePush: function () { return setIsPushed(function (prevState) { return !prevState; }); }, isDark: isDark, href: (_b = homeLink === null || homeLink === void 0 ? void 0 : homeLink.href) !== null && _b !== void 0 ? _b : "/" }),
...
exports.Alert = Alert;
exports.ApeIcon = Icon$5;
exports.ArrowBackIcon = Icon$6;
exports.ArrowDownIcon = Icon$7;
exports.ArrowDropDownIcon = Icon$8;
exports.ArrowDropDownSmallIcon = Icon$9;
exports.ArrowDropUpIcon = Icon$a;
exports.ArrowDropUpSmallIcon = Icon$b;
exports.ArrowForwardIcon = Icon$c;
exports.AutoRenewIcon = Icon$d;
exports.BackgroundImage = BackgroundImage;
exports.BananaGoldenIcon = Icon$f;
exports.BananaGoldenPairIcon = Icon$i;
exports.BananaIcon = Icon$e;
exports.BananaPairIcon = Icon$h;
exports.BaseLayout = GridLayout;
exports.BinanceIcon = Icon$j;
exports.BlockIcon = Icon$2;
exports.Breadcrumbs = Breadcrumbs;
exports.BunnyPlaceholderIcon = Icon$k;
exports.Button = Button;
exports.ButtonMenu = ButtonMenu;
exports.ButtonMenuItem = ButtonMenuItem;
exports.ButtonSquare = ButtonSquare;
exports.CalculateIcon = Icon$m;
exports.Card = Card;
exports.CardBody = CardBody;
exports.CardFooter = CardFooter;
exports.CardHeader = CardHeader;
exports.CardRibbon = CardRibbon;
exports.CardViewIcon = Icon$l;
exports.CardsLayout = GridLayout$1;
exports.Checkbox = Checkbox;
exports.Checkmark2Icon = Icon$o;
exports.CheckmarkCircleIcon = Icon;
exports.CheckmarkIcon = Icon$n;
...
exports.LogoRoundIcon = Icon$A;
exports.Menu = Menu;
exports.MetamaskIcon = Icon$B;
exports.MinusIcon = Icon$C;
exports.Modal = Modal;
exports.ModalProvider = ModalProvider;
exports.MonkeyLight = Icon$g;
